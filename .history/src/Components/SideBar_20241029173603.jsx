...
<div className='flex flex-col text-md'>
              ...
              <Settings>
                <div className="flex items-center gap-2 py-2 hover:bg-blue-gray-100 rounded transition cursor-pointer ">
                  <img src="public/assets/settings-svgrepo-com.svg" className="w-4" alt="Settings Icon" />
                  <span>Settings</span>
                </div>
              </Settings>
              <Link onClick={handleSignOut} className="flex items-center gap-2 py-2 hover:bg-blue-gray-100 rounded transition">
                <img src="public/assets/logout-2-svgrepo-com.svg" className="w-4" alt="Logout Icon" />
                <span>Log Out</span>
              </Link>
