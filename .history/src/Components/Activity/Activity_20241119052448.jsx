...
function ActivityPage() {
  ...
  return (
    ...
    <div className='flex mx-auto flex-col  gap-[20px]'>
      <div onClick={ () => {navigate(`/${userName}`)}} className='flex mr-auto mt-[50px] bg-gray-300 rounded-l-2xl'>
        <img className='w-[120px] h-[120px] rounded-l-2xl shadow-xl' src={userData?.photoURL} />
