  ...
  useEffect(() => {
    const fetchActivityData = async () => {
      try {
        ...
        setLoading(false)
        console.log(processedActivities && processedActivities.length <= 0)
  ...
  return (
    ...
    <div className='flex mx-auto flex-col  gap-[20px]'>
      ...
      <div className='bg-[#F5F4F4] w-full p-[20px] mb-11 rounded-md max-w-[800px] flex flex-col mx-auto shadow-md'>
        ...
        {!loading && processedActivities && processedActivities.length <= 0 ? (<p className='mx-auto' >No Activity Data :(</p>) : ''}
      </div>
