              ...
              {index > 0 && activity.transportType && (
                (
                  <div className={`flex flex-col-reverse items-center px-2 -mb-2 mt-4 ${activity.dayNumber === processedActivities[index - 1].dayNumber || activity.dayNumber === 1 ? 'border-l-2 border-dashed border-gray-600 py-10' : 'pt-10'} `} >
                    ...
                    <div className={`pr-4 text-2xl ml-auto mb-12  ${activity.dayNumber === processedActivities[index - 1].dayNumber || activity.dayNumber === 1 ? 'hidden' : ''} `}> Day {activity.dayNumber}</div>
                  </div>)
              )}
