...
function ActivityPage() {
  ...
  useEffect(() => {
    const fetchActivityData = async () => {
      try {
        ...
        const activitySnapshot = await getJourney(`/journeyData/${documentRef}/acivity`);
        setLoading(false)
  ...
  return (
    <div className='flex flex-col  gap-[20px]'>
      <div onClick={ () => {navigate(`/${userName}`)}} className='flex w-full max-w-[800px] mx-auto mt-[50px]'>
        <img className='w-[120px] h-[120px] rounded-2xl shadow-xl ml-auto' src={userData?.photoURL} />
        <div className='flex flex-col pl-2 w-auto'>
