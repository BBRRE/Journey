...
import { updateJourneyLikes } from "../../Config/firestore";
...
export default function Overview(props) {
  ...
  return (<>
    <div onClick={console.log(props)} className="relative w-[90%] h-[350px] rounded-t-2xl flex flex-col max-w-[500px] mx-auto 2xl:ml-auto 2xl:mr-0 " >
        ...
        <Link to={`/${props.obj.userName}/${props.obj.id}`}>
          ...
          <div className="flex justify-between py-2 items-center mt-auto pb-[5px]">
            ...
            <span>{likes}</span>
              ...
              <img className="h-[24px]" src={'public/assets/share-svgrepo-com.svg'}/>
            </div>
          </div>
        </div>
    </div>
