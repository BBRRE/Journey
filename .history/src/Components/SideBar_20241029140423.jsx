...
export const SideBar = ({ currentPage, onFilterApply  }) => {
  const { user } = UserAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const filteredResults = await filteredSearch(filterData);
      console.log(filteredResults)
      onFilterApply(filteredResults); // Pass filtered data to Home
    } catch (error) {
