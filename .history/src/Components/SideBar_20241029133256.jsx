...
export const SideBar = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log( await filteredSearch(filterData))
  ...
  return (
    <div className="hidden 2xl:block 2xl:w-1/4 h-full rounded-l-3xl bg-gray-100">
      ...
      <div className="w-[95%] rounded-lg bg-blue-gray-100 border-2 py-3 mx-auto flex flex-col my-4 font-sans font-semibold text-xl gap-2 text-left">
        {user ? (
          <>
            <Link to="/">
              <div className="flex gap-2 ml-[50px] my-auto">
                <img src="public/assets/Compass.svg" className="w-[30px]" alt="Explore Icon" />
                <span className="my-auto">Explore Page</span>
              </div>
            </Link>
            <Link to="/AddJourney">
              <div className="flex gap-2 ml-[50px] my-auto">
                <img src="public/assets/Plus.svg" className="w-[30px]" alt="Add Journey Icon" />
                <span className="my-auto">Post Log</span>
              </div>
            </Link>
            <Settings>
              <div className="flex gap-2 ml-[50px] my-auto">
                <img src="public/assets/settings-svgrepo-com.svg" className="w-[30px]" alt="Settings Icon" />
                <span className="my-auto">Settings</span>
              </div>
            </Settings>
            <Link>
              <div className="flex gap-2 ml-[50px] my-auto">
                <img src="public/assets/logout-2-svgrepo-com.svg" className="w-[30px]" alt="Logout Icon" />
