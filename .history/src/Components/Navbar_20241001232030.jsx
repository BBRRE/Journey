...
const Navbar = () => {
  ...
  return (
    <>
      <div className='w-full h-[7vh] md:h-[5.5vh] backdrop-blur-lg bg-blue-gray-700 bg-opacity-30 min-h-[50px] pt-[2px] bg fixed inset-x-0 bottom-0 flex flex-row content-center z-50 border-t-2 border-t-blue-gray-300 border-opacity-85 rounded-t-3xl'>
