...
const AddJourneyV2 = () => {
  ...
  const getfileAct = (event, index) => {
    // Create a copy of the current activitesImages array
    const updatedImages = [...activitesImages];
    ...
    // Update the specific index with the new images
    updatedImages[index] = newImages;
    
    // Set the state with the updated images
    setActivitesImages(updatedImages);
  };
          ...
          <div className='w-full h-auto  flex flex-col gap-2 '>
            <div className={` relative w-full h-auto border-black border-dashed border-4`}>
              <input
                ...
                multiple
              />
    <Gallery images={activitesImages[i] || []} />
        ...
        <form className='w-full h-auto mx-auto' >
          <div className="flex flex-col mb-[100px] mt-12 mx-auto max-w-[500px] justify-center items-center gap-24">
            ...
            <div className='flex w-full '>
              ...
              <div className='w-full border-4 border-black flex items-center justify-center' type='button' onClick={() => { setActivites(activites - 1) }} >remove activity</div>
