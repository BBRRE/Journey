  ...
  return (
    <><div className="2xl:flex ">
        ...
        <div className="flex flex-col mb-[100px] mt-12 2xl:w-[50%] mx-auto">
          ...
          >
            <h1 className="text-4xl font-fontMain self-start mb-10 border-b-2 border-black pr-[25px] ">Overview</h1>
            ...
            <div id="activities" className="flex flex-col w-[100%] gap-[20px] mt-[20px] ">
              {activites ? <h1 className="text-4xl font-fontMain self-start mb-10 border-b-2 border-black pr-[25px] ">Activities</h1> : null}
              {addActivityForm()}
            </div>
            <div className="flex w-[100%] max justify-center items-center gap-[10px] h-[2rem] mt-">
              <button
                type="button"
