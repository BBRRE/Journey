...
const AddJourneyV2 = () => {
  ...
  const onSubmit = async (uuid,data) => {
    let totalPrice = 0;
    ...
    for (let i = 1; i < activites + 1; i++) {
      await addActivityData(
        ...
        `/JourneyImages/${user.currentUser.uid}/${uuid}/Activity ${i}`,
        dataRef,
        i
      );
    ...
    return (
      <div className="2xl:flex">
        ...
        <form onSubmit={handleSubmit(uuid(),onSubmit)} className='w-full h-auto mx-auto'>
