              ...
              {fields.map((field, index) => (
                <div key={field.id} className='flex flex-col gap-2 w-full'>
                  ...
                  <div className='w-full h-auto flex flex-col gap-2'>
                    <div className="relative flex w-full h-auto border-black border-dashed border-2">
                    <div className={`mx-auto z-10 ${activitiesImages[index] ? 'hidden' : ''} `}>Uplaod an image</div>
                      <input
                        type="file"
                        multiple
