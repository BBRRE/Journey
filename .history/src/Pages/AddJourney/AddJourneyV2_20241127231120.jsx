    ...
    <div className="2xl:flex">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className='w-full h-auto mx-auto'>
        <div className="flex flex-col mb-[100px] mt-12 mx-auto max-w-[500px] justify-center items-center gap-4">
          ...
          <div className='relative flex justify-center align items-center w-full max-w-[500px] h-[200px] z-10 cursor-pointer mx-auto mb-[-30px] bg-transparent'>
            ...
            <input
              ...
              type="file"
              required
              className={`z-10 absolute top-0 left-0 w-full h-full p-4 opacity-0 cursor-pointer `}
              accept="image/*"
            ...
            <img
              src={overviewImage}
              className="w-full h-full object-cover rounded-t-2xl bg-gray-400"
              style={{
                clipPath: 'url(#curvedMask)',
                WebkitClipPath: 'url(#curvedMask)',
                WebkitMaskImage: 'linear-gradient(to top, transparent 0%, black 40%)'
