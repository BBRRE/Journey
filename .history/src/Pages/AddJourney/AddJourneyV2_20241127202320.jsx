...
const AddJourneyV2 = () => {
  ...
  const getfileAct = (event,number) => {
    ...
    activity.push(event.target.files[i])
  }
  console.log({...activity, activityNum:number})
      ...
      activityData.push(
        <div className='flex flex-col gap-2 w-full'>
          ...
          <div className='w-full h-auto flex flex-col gap-2 '>
            <div className=' relative w-full h-[400px] border-black border-dashed border-4'>
              <input
                type="file"
                ...
                multiple
              />
              <Gallery images={activitesImages} />
            </div>
            <input
              required
              maxLength={30}
