...
const AddJourneyV2 = () => {
  ...
  const [activities, setActivities] = useState([{}]); // Initialize with one empty activity

  const addActivity = () => {
    setActivities([...activities, {}]); // Add a new activity
  };
  ...
  return (
    <>
      <div className="2xl:flex">
        ...
        <div key={index} className="flex flex-col w-full gap-16 relative pt-[20px]">
          <div
          ...
          <div className="w-full h-auto flex flex-col gap-2 max-w-[500px]">
            <div className="w-full h-[400px] border-black border-dashed border-4">
              {/* Replace <Gallery /> with your actual component */}
            ...
            <div className='flex w-full '>
              <div className='w-full border-4 border-black flex items-center justify-center' type='button' onClick={addActivity} >Add activity</div>
