        ...
        <div className="flex flex-col mb-[100px] mt-12 mx-auto max-w-[500px] justify-center items-center gap-4">
          ...
          <div className='flex w-full gap-2'>
            <button
              type="button"
              onClick={() => append({})}
              className='w-full border-4 border-gray-900 rounded-md flex items-center justify-center font-semibold'
            >
              Add Activity
            </button>
            <button
              ...
              className='w-full border-4 border-gray-900 rounded-md flex items-center justify-center'
            >
              Remove Activity
            </button>
            <button
              type="submit"
              className='w-full bg-blue-gray-600 rounded-md flex items-center justify-center'
            >
              Submit
            </button>
          </div>
