...
const AddJourneyV2 = () => {
  ...
  const onSubmit = async (data) => {
    console.log(data)
    console.log(          i > 0 && data.activities[i - 1].dayNumber === data.activities[i].dayNumber ? '' :  data.activities[i].dayNumber)
    const suuid = uuid();
    let totalPrice = 0;
    ...
    try {
      ...
      for (let i = 0; i < data.activities.length; i++) {
        await addActivityData(
          ...
          i > 0 && data.activities[i - 1].dayNumber === data.activities[i].dayNumber ? '' :  data.activities[i].dayNumber
        );
