...
export default function ExplorePage({ criteria }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const { data, lastVisible } = await getJourney(`journeyData`, criteria, null, lastVisible);
      
      setDisplayedInfo((prevData) => [...prevData, ...data]);
      setLastVisible(lastVisible);
      setLoading(false);
    };

    fetchData();
  }, [criteria]); // Only fetch new data when criteria changes
