...
{loading ? (
  <>
  <div className="space-y-4 animate-pulse relative w-[90%] h-[350px] rounded-t-2xl flex flex-col max-w-[500px] mx-auto bg-gray-300 ">
  <div className="relative w-full h-[200px] z-10">
        <svg width="0" height="0" viewBox="0 0 100 100">
          ...
          <div
            alt="Masked Image"
            className="bg-gray-500 animate-pulse w-full h-full"
            style={{
