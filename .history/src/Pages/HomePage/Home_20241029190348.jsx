        ...
        <div className="flex-grow 2xl:w-3/4">
          <div className="flex flex-col">
            <div className="flex justify-between px-[10px] my-[50px] mb-[20px] w-full">
              ...
              {window.innerWidth < 1320 ?( <Settings> <img src="public/assets/settings-svgrepo-com.svg" className="w-[30px]" /></Settings> ): ''}
                
            </div>
              <HeaderStyle1 className='ml-[500px] ' >Explore The World</HeaderStyle1>
