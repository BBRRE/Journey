...
import { getFilteredJourneys } from "../../Config/firestore";
  ...
  useEffect(() => {
    const fetchFilteredData = async () => {
      try {
        ...
        const getFilteredJourneys = httpsCallable(functions, "getFilteredJourneys");
  
        const response = await getFilteredJourneys({
          collectionName: "journeyData",
          searchTerm: criteria?.searchTerm || null,
          filters: criteria?.filters || null,
        });
  
        setDisplayedInfo(response.data);
      } catch (error) {
