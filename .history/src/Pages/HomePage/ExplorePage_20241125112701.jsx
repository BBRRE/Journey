...
export default function ExplorePage({ criteria }) {
  ...
  const handleScroll = (event) => {
    ...
    if (div.scrollHeight - div.scrollTop === div.clientHeight) {
      ...
      // Call the function you want to trigger when fully scrolled
      console.log('hit ti',isScrolledToBottom)
    } else {
  ...
  const onScrollToBottom = () => {
    console.log('Div has been fully scrolled!');
  ...
  return (
    <div onScroll={handleScroll} className="mx-auto h-auto flex flex-col items-center gap-x-6 gap-y-12 p w-full 2xl:grid 2xl:grid-cols-2 almost3XL:grid-cols-3  ">
{loading ? (
