...
export default function Home() {
  ...
  return (
    <>
      <div className="flex flex-col 2xl:flex-row w-full h-auto gap-10">
        ...
        <div className="flex-grow 2xl:w-3/4">
          <div className="flex flex-col">
            ...
            <div className="mx-auto h-auto flex flex-col items-center gap-6 p w-full 2xl:grid 2xl:grid-cols-2 almost3XL:grid-cols-3  ">
