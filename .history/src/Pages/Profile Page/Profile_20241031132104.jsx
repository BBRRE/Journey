...
<div className='flex flex-col w-full h-auto mt-12 '>
  <div className='w-full bg-gradient-to-r from-blue-500 to-purple-500 pb-1'> <div className='h-full w-full bg-[#f2f2f2 ] flex justify-between px-12' ><h1 onClick={() => {setView(true)}}>My posts</h1><h1 onClick={() => {setView(false)}}>Liked posts</h1> </div></div>
