    ...
    <>
      <div className='flex'>
        ...
        <div className='flex flex-col 2xl:flex-row w-full'>
          ...
          <div className={`flex flex-col items-start w-full h-auto mt-12 ${user.email === userData?.email ? 'hidden' : 'flex'} `}>
            <div className='flex w-[90%] max-w-[1160px] mx-auto my-[20px] 2xl:blcok'>
              <img className='w-[120px] h-[120px] rounded-2xl shadow-lg' src={userData?.photoURL} />
              <div className='flex flex-col pl-4 w-[250px]'>
                <span className='font-semibold text-lg' >@{userName}</span>
                <div className="flex itens-center ">
