    ...
    <>
      <div className='flex'>
        ...
        <div className='flex flex-col 2xl:flex-row w-full'>
          <div className='w-[400px] h-auto z-10 hidden 2xl:block' >
            <SideBar />
          </div>
          ...
          <div className="grid mt-[50px] mb-[150px] mx-auto gap-[20px] 2xl:grid-cols-2 grid-cols-1 w-full vert 2xl:ml-[100px]">
            {myData ? "You haven't uploaded anything yet" :  ''}
            {why()}
          </div>
        </div>
