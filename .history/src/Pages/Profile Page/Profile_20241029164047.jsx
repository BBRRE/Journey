...
export default function Profile() {
  ...
  return (
    <>
    <div className='flex'>
      <div className='w-[400px] h-auto z-10' >
      <SideBar/>
</div>
        <div className='flex flex-col w-full'>
          <div className='w- md:w-full h-[200px] bg-gradient-to-br from-secondaryAc-light to-secondaryAc-dark flex items-center m-[0px]' >
