...
export default function Profile() {
  ...
  const likedData = () => {
    ...
    <>
      <div className='flex flex-col align-middle mb-auto'>
        <Overview
          key={crypto.randomUUID()}
          obj={x}
        >
...
<div className='flex flex-col w-full h-auto mt-12 '>
  ...
  <div className="relative w-full h-[200px] z-10">
      ...
      <div className="h-8 bg-gray-300 rounded w-full"></div>
                ...
                <div className="grid mt-[50px] mb-[150px] mx-auto gap-[20px] 2xl:grid-cols-2 h-auto grid-cols-1 w-full vert 2xl:ml-auto 2xl:mr-0">
